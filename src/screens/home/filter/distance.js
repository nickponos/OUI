         ...
         return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ borderBottomWidth: 1, borderColor: '#f2f3f5' }}>
                    ...
                    <View style={{borderBottomWidth: 1, borderColor: '#f2f3f5'}}>
                        <Text style={{ marginLeft:'5%', marginTop: 20, marginBottom: 10, color: '#000', fontSize: RFValue(13.6), fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular', }}>{this.state.distance}km</Text>
