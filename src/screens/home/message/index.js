        ...
        if (this.state.allMessages.length > 0) {
                ...
                <View style={{ width: '100%', }}>
                    <FlatList
                        ...
                        renderItem={({ item, index }) =>
                            <TouchableOpacity onPress={()=>navigationService.navigate(screens.CHATS, {_type:item.type})} style={{ flex: 1, width: '100%', paddingVertical: 10, borderBottomWidth: 1, borderColor: '#f2f3f5' }}>
            ...
            return (
                <View style={{ alignSelf: 'center', marginTop: '30%', flex: 1, width: '95%' }}>
                    <Text style={{ paddingBottom: 10, fontSize: RFValue(18.36), color: '#000', fontFamily: Platform.OS == 'ios' ? 'Lato-Bold' : 'Lato Bold', textAlign: 'center' }}>No Messages yet</Text>
                    <Text style={{ fontSize: RFValue(17), color: '#d8d7dd', fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular', textAlign: 'center' }}>Talk privately with anyone who follow you or with group by participating to any event  </Text>
                </View>
            )
        }
    }
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.subContainerView}>
                    <View style={{ marginTop: 10, marginBottom: 7, marginHorizontal: 20 }}>
                        <Text style={{ fontSize: RFValue(25.84), fontFamily: Platform.OS == 'ios' ? 'Lato-Bold' : 'Lato Bold', color: '#000' }}>Messages</Text>
                    </View>
