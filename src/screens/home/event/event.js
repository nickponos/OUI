        ...
        <TouchableWithoutFeedback>
          ...
          <View style={{}}>
            ...
            <TouchableOpacity style={[styles.buttoncontainer]} disabled={this.state.starCount ? false : true} 
              ...
              onPress={()=>navigationService.push(screens.APP)}
              >
        ...
        <View style={styles.container}>
          <View style={styles.headerView}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TouchableOpacity onPress={()=>navigationService.pop()}><Image style={{ height: 20, width: 20, }} source={require('../../../assets/images/close.png')} /></TouchableOpacity>
            </View>
          </View>
        </View>
      </ImageBackground> :
        ...
        {/* <SwipeUpDown
            ...
            itemMini={
              ...
              <View style={{ width: '90%', alignSelf: 'center' }}>
                ...
                <Text style={{ marginTop: 10, color: '#000', fontSize: RFValue(15.64), fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular' }}> {'Travel'.toUpperCase()} </Text>
                <Text numberOfLines={1} style={{ marginTop: 7, width: Platform.OS == 'ios' ? '75%' : '65%', color: '#000', fontSize: RFValue(23.8), fontFamily: Platform.OS == 'ios' ? 'Lato-Bold' : 'Lato Bold' }}>Trip to Plam Shores Beaches</Text>
