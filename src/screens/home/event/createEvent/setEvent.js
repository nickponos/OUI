...
export default class AddEvent extends Component {
        ...
        return (
            <View style={styles.textinputcontainer}>
                ...
                <View style={{ width: '65%', }}>
                    <TextInput
                        style={styles.text}
                        fontSize={name == "Title" ? RFValue(21.76) : RFValue(14.96)}
                        placeholder={name}
                        multiline={mline}
    ...
    _next() {
        ...
        if (title && date1 && date2 && meetingplace && notes) {
            ...
            navigationService.navigate(screens.ADDEVENT_SETGUEST, { eventDetails: data, serachData: this.props.serachData });
        }
        else {
                ...
                <View style={styles.subContainerView}>
                    <View style={{ borderBottomWidth: 1, borderColor: '#f2f3f5' }}>
                        ...
                        <View style={{ justifyContent: 'flex-start', width: '90%', alignSelf: 'center', paddingVertical: 15 }}>
                            <Text style={{ color: '#000', fontSize: RFValue(20.4), fontFamily: Platform.OS == 'ios' ? 'Lato-Bold' : 'Lato Bold', }}>Set your event</Text>
                        </View>
                    </View>
