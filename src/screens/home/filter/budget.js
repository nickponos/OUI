        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ borderBottomWidth: 1, borderColor: '#f2f3f5' }}>
                    ...
                    <View style={{borderBottomWidth: 1, borderColor: '#f2f3f5'}}>
                        <Text style={{ marginLeft:'5%',marginTop: 20, marginBottom: 10, color: '#000', fontSize: RFValue(13.6), fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular', }}>{this.state.filter_age[0]+'\u20AC'} - {this.state.filter_age[1]+'\u20AC'}</Text>
                    ...
                    <View  style={{borderBottomWidth: 1, justifyContent:'space-between', borderColor: '#f2f3f5',flexDirection:'row',alignItems:'center'}}>
                        <Text style={{ marginTop:20,marginBottom:20,marginLeft:'5%', color: '#000', fontSize: RFValue(13.6), fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular', }}>Split budget</Text>
                    <Switch
                        style={{marginRight:'3%'}}
