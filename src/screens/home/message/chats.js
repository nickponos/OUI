                 ...
                 <View style={{flex:1,backgroundColor:'rgba(0.5,0.5,0.5,0.5)',alignItems:'center'}}>
                    ...
                    <TouchableWithoutFeedback>
                      <View style={{justifyContent:'center',alignItems:'center',width:'100%'}}>
                            ...
                            <Text style={{fontSize: RFValue(19.04),marginTop:15,color:'black',fontFamily: Platform.OS == 'ios' ?  'Lato-Bold' : 'Lato Bold'}}>Make meating up easier</Text>
                            <Text style={{fontSize: RFValue(17),marginVertical:5,textAlign:'center',fontFamily: Platform.OS == 'ios' ?  'Lato-Regular' : 'Lato Regular'}}>Share your location to make  meating up with firends easier</Text>
                            <Button onClick={() => this.setState({sharelocationModal:false},()=>navigationService.navigate(screens.LIVE_LOCATION))} buttonText='Okay' colors={['#a65ae1', '#8a4cea'] } style={{ marginTop: 35,width:'100%' }} />
                       </View>
                       </TouchableWithoutFeedback>
                    </View>
                </View>
           ...
           <View style={{padding:10,width:'70%',flexDirection:'row'}}>
                    ...
                    <View style={{marginLeft:10,width:'100%'}}>
                            ...
                            <MapView
                              ...
                              <Text style={{fontSize: RFValue(14.96)}}>{item.date}</Text>   
                            </View>
                            :
                        item.msgtype=='image'?
                            <View style={{marginLeft:10,width:'100%'}}>
                      ...
                      <View style={{marginLeft:10}}>
                            <View style={{backgroundColor:'#f3f3f5',padding:10,borderRadius:10}}>
                                <Text style={{ fontSize: RFValue(17),color:'black',fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular'}}>{item.msg}</Text>
                            </View>
                              <Text style={{fontSize: RFValue(14.96)}}>{item.date}</Text>   
                      </View>}
            </View>       
            ...
            <View style={{padding:10,marginRight:10,width:'70%',alignSelf:'flex-end'}}>
              ...
              { item.msgtype=='location'?
                    ...
                    <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#a65ae1', '#8a4cea']}  style={{padding:10,borderRadius:10}} >  
                            <Text style={{fontSize: RFValue(17), fontFamily: Platform.OS == 'ios' ? 'Lato-Regular' : 'Lato Regular',color:'white'}}>{item.msg}</Text>
                    </LinearGradient>
                    </View>                
              }
            ...
            <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS=='ios'?'padding':null}>
                <Header style={{backgroundColor:'white'}}>
                    ...
                    <View style={{width:'80%',justifyContent:'center',alignItems:'center'}}>
                        <Text style={{fontSize: RFValue(20.4),color:'black',fontFamily: Platform.OS == 'ios' ? 'Lato-Bold' : 'Lato Bold'}}>{this.props._type == 'user' ? 'Izabella' : 'Trip to palm Shores...'}</Text>
                    </View>
                    <View style={{width:'10%'}}>
                    </View>
                </Header>
                ...
                <View style={{flex:1}}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                        ...
                        <TouchableOpacity disabled={!this.state.message} style={{justifyContent:'flex-end'}}>
                            <Text style={{fontSize: RFValue(20.4), fontFamily: Platform.OS == 'ios' ?  'Lato-Bold' : 'Lato Bold',color:this.state.message?'#9246e6':'grey'}}>Send</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                </View>
