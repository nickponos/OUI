...
const dot = <Icon name='dot-single' type='Entypo' style={{ fontSize: 10, color: 'white', marginHorizontal: 4 }} />
                                ...
                                <TouchableOpacity onPress={() => this.props.onPress({ image: item.image, name: item.name, prof: item.prof })} style={styles.cartContainer}>
                                    ...
                                    <View style={{ height: 350, width: 300 }}>
                                        <Image resizeMode='cover' source={item.image}
                                            style={{ height: 350, width: 300, borderRadius: 12 }} />

                                        <View style={{ position: 'absolute', top: 8, left: 8, right: 8, alignItems: 'flex-end' }}>
                                            <TouchableOpacity >
                                                <Icon name='close' type='MaterialIcons' style={{ color: '#fff', }} />
                                            </TouchableOpacity>
                                            {/* <TouchableOpacity onPress={() => this.setState(state => (this.state.peoples[index].like = !peoples[index].like, state))}>
